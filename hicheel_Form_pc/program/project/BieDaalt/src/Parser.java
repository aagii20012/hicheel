...
public class Parser {
    ...
    private Statement statement() {
        ...
        switch(token.type())
        {
        	...
        	case ForLoop: s = this.forStatement(); break;
        	// student exercise
    ...
    private For forStatement () {
    	...
    	token = lexer.next();
    	match(TokenType.LeftParen);
    	Assignment decs= assignment();
        Expression t = expression();
        match(TokenType.Semicolon);
        Assignment assegn= assignment();
        match(TokenType.RightParen);
        return new For(decs,assegn,t, this.statement()); 
    }
    ...
    public static void main(String args[]) {
        ...
        Parser parser  = new Parser(new Lexer("src/newton.cpp"));
