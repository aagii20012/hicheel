...
class Program {
    ...
    private String BlockText (For f, String tab) {
        ...
        val += tab + "  Block:\n";
        val += this.BlockText(f.decs, tab + "  ") + "\n";
        val += this.BlockText(f.asgn, tab + "  ") + "\n";
...
class For extends Statement {
	...
	Expression test;
	Assignment decs,asgn;
    Statement body;

    For (Assignment a,Assignment c,Expression t, Statement b) {
        test = t; body = b;decs = a; asgn = c;
    }
